...
class AddPersonalizationsDialogue extends StatefulWidget {
  const AddPersonalizationsDialogue({super.key, this.personalizationModel});

  final PersonalizationModel? personalizationModel;

  @override
  State<AddPersonalizationsDialogue> createState() =>
      _AddPersonalizationsDialogueState();
}

class _AddPersonalizationsDialogueState
    extends State<AddPersonalizationsDialogue> {
