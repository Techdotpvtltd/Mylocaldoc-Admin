...
class RadarChartSample1 extends StatefulWidget {
  ...
  final gridColor = ChartsColors.contentColorPurple.lighten(80);
  final titleColor = ChartsColors.contentColorPurple.lighten(80);
  final fashionColor = ChartsColors.contentColorRed;
  final artColor = ChartsColors.contentColorCyan;
  final boxingColor = ChartsColors.contentColorGreen;
  final entertainmentColor = ChartsColors.contentColorWhite;
  final offRoadColor = ChartsColors.contentColorYellow;
      ...
      child: Column(
        ...
        children: [
          const Text(
            'Title configuration',
            style: TextStyle(
              color: ChartsColors.mainTextColor2,
            ),
          ),
          Row(
            children: [
