...
class BarChartSample4 extends StatefulWidget {
  ...
  final Color dark = ChartsColors.contentColorCyan.darken(60);
  final Color normal = ChartsColors.contentColorCyan.darken(30);
  final Color light = ChartsColors.contentColorCyan;
              ...
              BarChartData(
                ...
                gridData: FlGridData(
                  ...
                  getDrawingHorizontalLine: (value) => FlLine(
                    color: ChartsColors.borderColor.withOpacity(0.1),
                    strokeWidth: 1,
                  ),
