...
class BarChartSample6 extends StatelessWidget {
  ...
  final pilateColor = appColors.blueIconColor;
  final cyclingColor = appColors.teal100;
  final quickWorkoutColor = ChartsColors.contentColorBlue;
  ...
  Widget bottomTitles(double value, TitleMeta meta) {
    final style = TextStyle(fontSize: 10, color: appColors.blueGray300);
    String text;
    switch (value.toInt()) {
      case 0:
        text = 'JAN';
