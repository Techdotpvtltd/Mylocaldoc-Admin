  ...
  Widget leftTitleWidgets(double value, TitleMeta meta) {
    ...
    switch (value.toInt()) {
      ...
      case 2:
        ...
        color = ChartsColors.contentColorRed;
        break;
      case 4:
      ...
      rangeAnnotations: RangeAnnotations(
        verticalRangeAnnotations: [
          VerticalRangeAnnotation(
            x1: 2,
            x2: 5,
            color: ChartsColors.contentColorBlue.withOpacity(0.2),
          ),
          VerticalRangeAnnotation(
            x1: 8,
            x2: 9,
        ...
        horizontalRangeAnnotations: [
          HorizontalRangeAnnotation(
            y1: 2,
            y2: 3,
            color: ChartsColors.contentColorGreen.withOpacity(0.3),
          ),
        ],
      ),
...
//         extraLinesOnTop: true,
      ...
      lineTouchData: LineTouchData(
        ...
        getTouchedSpotIndicator:
          ...
          return spotIndexes.map((spotIndex) {
            return TouchedSpotIndicatorData(
              const FlLine(
                  color: ChartsColors.contentColorOrange, strokeWidth: 3),
              FlDotData(
        ...
        touchTooltipData: const LineTouchTooltipData(
          tooltipBgColor: ChartsColors.contentColorBlue,
        ),
      ),
