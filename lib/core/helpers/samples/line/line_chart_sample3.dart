...
class LineChartSample3 extends StatefulWidget {
  ...
  })  : lineColor = lineColor ?? ChartsColors.contentColorRed,
        indicatorLineColor = indicatorLineColor ??
            ChartsColors.contentColorYellow.withOpacity(0.2),
        indicatorTouchedLineColor =
            indicatorTouchedLineColor ?? ChartsColors.contentColorYellow,
        indicatorSpotStrokeColor = indicatorSpotStrokeColor ??
            ChartsColors.contentColorYellow.withOpacity(0.5),
        indicatorTouchedSpotStrokeColor =
            indicatorTouchedSpotStrokeColor ?? ChartsColors.contentColorYellow,
        bottomTextColor =
            bottomTextColor ?? ChartsColors.contentColorYellow.withOpacity(0.2),
        bottomTouchedTextColor =
            bottomTouchedTextColor ?? ChartsColors.contentColorYellow,
        averageLineColor =
            averageLineColor ?? ChartsColors.contentColorGreen.withOpacity(0.8),
        tooltipBgColor = tooltipBgColor ?? ChartsColors.contentColorGreen,
...
class _LineChartSample3State extends State<LineChartSample3> {
  ...
  Widget leftTitleWidgets(double value, TitleMeta meta) {
    ...
    final style = TextStyle(
      color: ChartsColors.mainTextColor1.withOpacity(0.5),
      fontSize: 10,
    );
    String text;
    switch (value.toInt()) {
        ...
        Row(
          ...
          children: <Widget>[
            ...
            const Text(
              ' and ',
              style: TextStyle(
                color: ChartsColors.mainTextColor1,
                fontWeight: FontWeight.bold,
                fontSize: 16,
              ),
            ),
            ...
            child: LineChart(
              LineChartData(
                ...
                borderData: FlBorderData(
                  show: true,
                  border: Border.all(
                    color: ChartsColors.borderColor,
                  ),
                ),
                gridData: FlGridData(
                  show: true,
                  ...
                  getDrawingHorizontalLine: (value) {
                    if (value == 0) {
                      return const FlLine(
                        color: ChartsColors.contentColorOrange,
                        strokeWidth: 2,
                      );
                    } else {
                      return const FlLine(
                        color: ChartsColors.mainGridLineColor,
                        strokeWidth: 0.5,
                      );
                    }
                  },
